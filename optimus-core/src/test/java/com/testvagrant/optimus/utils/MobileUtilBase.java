...
/**
 * Created by krishnanand on 14/01/17.
 */
public class MobileUtilBase {
    ...
    protected List<String> androidProcessLog() {
        ...
        processLog.add("* daemon not running. starting it now on port 5037 *");
        processLog.add("* daemon started successfully *");
        return processLog;
    }
