Feature: Go BlueBird Estimate Fare scenarios

  @go_ride_regression @gojek_regression
  Scenario: Go BlueBird Validation conditions - Distance Limit
  ...
  @go_ride_regression @gojek_regression
  Scenario: Go BlueBird Validation conditions - Low go pay
